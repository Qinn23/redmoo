...
const sectionContent = (active, handleLogout, handleSwitchAccount, walletInfo, tickets, loadingTickets, showPurchaseSuccess, clearDemoPurchases, onViewDetails, balanceLoading, getFormattedBalance) => {
  if (active === "mytickets") {
    return (
