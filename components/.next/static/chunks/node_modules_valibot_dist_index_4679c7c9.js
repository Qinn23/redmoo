...
"[project]/node_modules/valibot/dist/index.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var EMOJI_REGEX = RegExp("^[\\p{Extended_Pictographic}\\p{Emoji_Component}]+$", "u");
...
function getGlobalConfig(config2) {
    var _config2_lang, _config2_abortEarly, _config2_abortPipeEarly;
    return {
        lang: (_config2_lang = config2 === null || config2 === void 0 ? void 0 : config2.lang) !== null && _config2_lang !== void 0 ? _config2_lang : store === null || store === void 0 ? void 0 : store.lang,
        message: config2 === null || config2 === void 0 ? void 0 : config2.message,
        abortEarly: (_config2_abortEarly = config2 === null || config2 === void 0 ? void 0 : config2.abortEarly) !== null && _config2_abortEarly !== void 0 ? _config2_abortEarly : store === null || store === void 0 ? void 0 : store.abortEarly,
        abortPipeEarly: (_config2_abortPipeEarly = config2 === null || config2 === void 0 ? void 0 : config2.abortPipeEarly) !== null && _config2_abortPipeEarly !== void 0 ? _config2_abortPipeEarly : store === null || store === void 0 ? void 0 : store.abortPipeEarly
    };
}
...
function getGlobalMessage(lang) {
    return store2 === null || store2 === void 0 ? void 0 : store2.get(lang);
}
function deleteGlobalMessage(lang) {
    store2 === null || store2 === void 0 ? void 0 : store2.delete(lang);
}
...
function getSchemaMessage(lang) {
    return store3 === null || store3 === void 0 ? void 0 : store3.get(lang);
}
function deleteSchemaMessage(lang) {
    store3 === null || store3 === void 0 ? void 0 : store3.delete(lang);
}
...
function getSpecificMessage(reference, lang) {
    var _store4_get;
    return store4 === null || store4 === void 0 ? void 0 : (_store4_get = store4.get(reference)) === null || _store4_get === void 0 ? void 0 : _store4_get.get(lang);
}
function deleteSpecificMessage(reference, lang) {
    var _store4_get;
    store4 === null || store4 === void 0 ? void 0 : (_store4_get = store4.get(reference)) === null || _store4_get === void 0 ? void 0 : _store4_get.delete(lang);
}
...
function _addIssue(context, label, dataset, config2, other) {
    ...
    var _other_received;
    const received = (_other_received = other === null || other === void 0 ? void 0 : other.received) !== null && _other_received !== void 0 ? _other_received : _stringify(input);
    const issue = {
        kind: context.kind,
        type: context.type,
        input,
    ...
    const message = (_ref4 = (_ref3 = (_ref2 = (_ref1 = (_other_message = other === null || other === void 0 ? void 0 : other.message) !== null && _other_message !== void 0 ? _other_message : // @ts-expect-error
    context.message) !== null && _ref1 !== void 0 ? _ref1 : getSpecificMessage(context.reference, issue.lang)) !== null && _ref2 !== void 0 ? _ref2 : isSchema ? getSchemaMessage(issue.lang) : null) !== null && _ref3 !== void 0 ? _ref3 : config2.message) !== null && _ref4 !== void 0 ? _ref4 : getGlobalMessage(issue.lang);
    if (message) {
...
var ValiError = class extends Error {
   ...
   * The error issues.
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$client$5d$__$28$ecmascript$29$__["_"])(this, "issues", void 0);
        this.name = "ValiError";
        this.issues = issues;
    }
};
...
function mimeType(requirement, message) {
    return {
        ...
        reference: mimeType,
        async: false,
        expects: requirement.map((option)=>'"'.concat(option, '"')).join(" | ") || "never",
        requirement,
        message,
        _run (dataset, config2) {
    ...
    return {
        ...
        _run (dataset, config2) {
            action({
                ...
                addIssue: (info)=>{
                    var _info_label;
                    return _addIssue(this, (_info_label = info === null || info === void 0 ? void 0 : info.label) !== null && _info_label !== void 0 ? _info_label : "input", dataset, config2, info);
                }
            });
            return dataset;
        }
...
function forward(action, pathKeys) {
    return {
        ...
        _run (dataset, config2) {
            ...
            if (dataset.issues) {
                for (const issue of dataset.issues){
                    if (!(prevIssues === null || prevIssues === void 0 ? void 0 : prevIssues.includes(issue))) {
...
async function getDefaultsAsync(schema) {
    if ("entries" in schema) {
        return Object.fromEntries(await Promise.all(Object.entries(schema.entries).map(async (param)=>{
...
function enum_(enum__, message) {
    const options = Object.entries(enum__).filter((param)=>{
        let [key] = param;
        return isNaN(+key);
    }).map((param)=>{
        let [, value2] = param;
    ...
    return {
        ...
        _run (dataset, config2) {
            ...
            if (typedDatasets) {
                ...
                dataset.typed = true;
            } else if ((untypedDatasets === null || untypedDatasets === void 0 ? void 0 : untypedDatasets.length) === 1) {
...
function _discriminators(key, options) {
    let set2 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : /* @__PURE__ */ new Set();
...
function pipe() {
    for(var _len = arguments.length, pipe2 = new Array(_len), _key = 0; _key < _len; _key++){
        pipe2[_key] = arguments[_key];
    }
    return {
        ...pipe2[0],
        pipe: pipe2,
...
//# sourceMappingURL=node_modules_valibot_dist_index_4679c7c9.js.map