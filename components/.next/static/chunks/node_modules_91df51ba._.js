...
"[project]/node_modules/@wallet-standard/wallet/lib/esm/register.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function registerWallet(wallet) {
    ...
    try {
        window.addEventListener('wallet-standard:app-ready', (param)=>{
            let { detail: api } = param;
            return callback(api);
        });
    } catch (error) {
...
function DEPRECATED_registerWallet(wallet) {
    ...
    try {
        ((_a = window.navigator).wallets || (_a.wallets = [])).push((param)=>{
            let { register } = param;
            return register(wallet);
        });
    } catch (error) {
...
//# sourceMappingURL=node_modules_91df51ba._.js.map